...
- **(5)** Xác định True Foreground dựa trên ngưỡng `thres` (vùng màu trắng) với công thức:
...
- **(6)** Kết hợp True Background và True Foreground để tìm ra vùng Unknown.
- **(7)** Sử dụng thuật toán Watershed Segmentation để phân đoạn ký tự.
- **(8)** Sử dụng các tiêu chí như tỷ lệ chiều rộng và chiều cao để lọc ra ký tự.
""")

    st.image("UIUX/Watershed/metric_process/3.png", caption="Minh họa quá trình Watershed trên biển số xe")
